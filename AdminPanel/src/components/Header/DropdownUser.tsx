...
import UserOne from '../../images/user/admin-96.png';
import userLight from '../../images/user/white-admin-96.png';
import { TbLogout2 } from 'react-icons/tb';

const DropdownUser = ({ colorTheme }: any) => {
    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <img
            src={`${colorTheme == 'dark' ? userLight : UserOne}`}
