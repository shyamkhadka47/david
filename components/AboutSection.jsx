        ...
        <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="border-t-2 border-museum-gold pt-4">
              <p className="font-serif text-4xl font-bold mb-2">10k+</p>
            ...
            <div className="border-t-2 border-museum-gold pt-4">
              <p className="font-serif text-4xl font-bold mb-2">200k+</p>
              <p className="text-sm text-white/70 uppercase tracking-wide">
                Visitors
              </p>
            </div>
            <div className="border-t-2 border-museum-gold pt-4">
              <p className="font-serif text-4xl font-bold mb-2">30+</p>
              <p className="text-sm text-white/70 uppercase tracking-wide">
                Exhibitions
              </p>
            </div>
